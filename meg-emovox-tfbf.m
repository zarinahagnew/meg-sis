...
folder_name='/Users/zagnew/emovox_sis/R2774A_BURsar_w_megan'
cd(folder_name)
cd /Users/zagnew/EmoVoc_meg/TF_analysis

condition='laugh';

sess_file.sess_file= (sprintf('%s/R2447A_sess_speech_speakaligned_laugh',folder_name));
load trials.mat
gen_trialsubset_sessionfile(sess_file.sess_file, trials.laugh(1:45), 'laugh');

sess_file.sess_file= (sprintf('%s/session_speakaligned_lh_voi_speech',folder_name));
...
select selected Voxel" to bring you to the max time point at that voxel. 
